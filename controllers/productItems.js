...
export const createProduct = async (req, res) => {
  ...
  try {
    ...
    return res.status(404).json({ message: PRODUCT_NOT_CREATED_MSG });
  }
};
export const updateProduct = async (req, res) => {
  try {
    ...
    return res.status(404).json({ message: ERROR_UPDATING_PRODUCT });
  }
};
export const deleteProduct = async (req, res) => {
  try {
    await ProductItems.findByIdAndDelete(req.params.id);
    return res.status(200).json({ message: PRODUCT_DELETED_MSG });
  } catch (err) {
    return res.status(404).json({ message: ERROR_DELETE_PRODUCT_MSG });
  }
};
export const getAllProduct = async (req, res) => {
  try {
    ...
    return res
      .status(200)
      .json({ data: product, message: LIST_OF_ALL_PRODUCT });
  } catch (err) {
